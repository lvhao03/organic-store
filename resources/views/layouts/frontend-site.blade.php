                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> luongvihao03@gmail.com</li>
                                <li>Free Ship</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        @php
                            if(session()->has('cart')){
                                $num = count(session('cart'));
                            }
                        @endphp
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="/cart"><i class="fa fa-shopping-bag"></i> <span>{{$num ?? '0'}}</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>$150.00</span></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Địa chỉ: đường 42 hiệp Bình Chánh, TP Thủ Đức</li>
                            <li>Điện thoại: 123456</li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        ...
                        <p>Đăng ký để nhận được những thông báo mới nhất</p>
                        <form action="#">
